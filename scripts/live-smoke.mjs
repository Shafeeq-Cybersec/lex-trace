...
const report={testedAt:new Date().toISOString(),model:latest.model,initialMs,revisionMs,initialCitations:revision.audit.checkedCitations,revisionCitations:latest.audit.checkedCitations,initialTokens:{input:revision.audit.inputTokens,output:revision.audit.outputTokens},revisionTokens:{input:latest.audit.inputTokens,output:latest.audit.outputTokens},checks:['live AI mode','accurate amounts','two deductions','duplicate upload creates no job','immutable first revision','stable deduction IDs','new source linked in change']};
